...
const PROVIDERS: Record<string, Array<{ name: string; offer: string; rate: string; phone: string; website: string; logo: string; whatsapp: string; message: string }>> = {
  Home: [
    ...
    { name: "People's Credit Union", offer: 'Residential loans & mortgages for members', rate: '6.5–9%', phone: '+1 (868) 627-0000', website: 'peoplescu.tt', logo: '/logos/peoplescu.svg', whatsapp: '18686270000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a home loan. I\'d like to know more about your credit union mortgage options. My score: ' },
    { name: 'Sagicor Credit Union', offer: 'Home improvement & mortgage loans', rate: '7–9.5%', phone: '+1 (868) 628-4200', website: 'sagicor.com', logo: '/logos/sagicor.svg', whatsapp: '18686284200', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a home loan. I\'d like to know more about your home loan options. My score: ' },
  ],
  Car: [
    ...
    { name: "Teachers' Credit Union", offer: 'Auto loans for educators', rate: '6.5–8.5%', phone: '+1 (868) 627-8000', website: 'teacherscu.tt', logo: '/logos/teacherscu.svg', whatsapp: '18686278000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a car loan. I\'d like to know more about your auto loan options. My score: ' },
    { name: "People's Credit Union", offer: 'Vehicle financing for members', rate: '7–9%', phone: '+1 (868) 627-0000', website: 'peoplescu.tt', logo: '/logos/peoplescu.svg', whatsapp: '18686270000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a car loan. I\'d like to know about your vehicle financing. My score: ' },
  ],
  Education: [
    ...
    { name: "Teachers' Credit Union", offer: 'Education loans for teachers & family', rate: '5–7%', phone: '+1 (868) 627-8000', website: 'teacherscu.tt', logo: '/logos/teacherscu.svg', whatsapp: '18686278000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for an education loan. I\'d like to know about your education financing for educators. My score: ' },
    { name: 'UtoStar Credit Union', offer: 'Member education loans & fee financing', rate: '5.5–7.5%', phone: '+1 (868) 627-6000', website: 'utostar.com', logo: '/logos/utostar.svg', whatsapp: '18686276000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for an education loan. I\'d like to know about your credit union education loan options. My score: ' },
  ],
  Vacation: [
    ...
    { name: "People's Credit Union", offer: 'Personal loans & travel advances for members', rate: '8–11%', phone: '+1 (868) 627-0000', website: 'peoplescu.tt', logo: '/logos/peoplescu.svg', whatsapp: '18686270000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a travel loan. I\'d like to know about your personal loan options as a member. My score: ' },
    { name: 'Police Credit Union', offer: 'Personal loans for travel & leisure', rate: '7.5–10.5%', phone: '+1 (868) 627-1500', website: 'policecu.tt', logo: '/logos/policecu.svg', whatsapp: '18686271500', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a travel loan. I\'d like to know about your personal loan options. My score: ' },
  ],
  Business: [
    ...
    { name: 'UtoStar Credit Union', offer: 'Business start-up loans & working capital for members', rate: '6–11%', phone: '+1 (868) 627-6000', website: 'utostar.com', logo: '/logos/utostar.svg', whatsapp: '18686276000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a business loan. I\'d like to know about credit union business financing options. My score: ' },
    { name: 'Sagicor Credit Union', offer: 'SME loans & member business financing', rate: '7–12%', phone: '+1 (868) 628-4200', website: 'sagicor.com', logo: '/logos/sagicor.svg', whatsapp: '18686284200', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a business loan. I\'d like to know about your business loan products. My score: ' },
  ],
  Personal: [
    ...
    { name: "People's Credit Union", offer: 'Personal loans for members — no hidden fees', rate: '7.5–11%', phone: '+1 (868) 627-0000', website: 'peoplescu.tt', logo: '/logos/peoplescu.svg', whatsapp: '18686270000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a personal loan. I\'d like to know about your credit union personal loan rates. My score: ' },
    { name: "Teachers' Credit Union", offer: 'Personal loans for educators with competitive rates', rate: '7–10%', phone: '+1 (868) 627-8000', website: 'teacherscu.tt', logo: '/logos/teacherscu.svg', whatsapp: '18686278000', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a personal loan. I\'d like to know about your educator personal loan rates. My score: ' },
    { name: 'Police Credit Union', offer: 'Personal loans for police officers & family', rate: '6.5–9.5%', phone: '+1 (868) 627-1500', website: 'policecu.tt', logo: '/logos/policecu.svg', whatsapp: '18686271500', message: 'Hi, I completed a Lifeguage prequalification and got a loan eligibility score for a personal loan. I\'d like to know about your personal loan products for members. My score: ' },
  ],
};
